...
import { SITE_CONFIG } from '../data/index';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${displayName} | ${SITE_CONFIG.name} - Situs Hiburan Resmi`,
    description: `Jelajahi informasi eksklusif mengenai ${displayName} di platform ${SITE_CONFIG.name}. Keamanan terjamin dengan sistem enkripsi terbaik.`,
    alternates: {
          ...
          <div className="relative z-10">
            ...
            <div className="max-w-2xl mx-auto space-y-6">
              <p className="text-gray-400 text-xs md:text-sm font-bold uppercase tracking-widest leading-relaxed">
                Kami sedang melakukan kalibrasi sistem tingkat tinggi dihalaman ini untuk memastikan kategori <span className="text-yellow-500">{displayName}</span> hadir dengan standar kemenangan tertinggi. 
              </p>
